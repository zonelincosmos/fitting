...
TestOrder = 11;
TestLambda = 0;
for TestOrder = 5:2:11
% for TestLambda = 0:0.02:0.06
...
figure
subplot(3,1,1)
plot(residue,  '.-', 'LineWidth', 2, 'MarkerSize',25, 'MarkerEdgeColor','blue')
grid on

subplot(3,1,2)
plot(residue2,  '.-', 'LineWidth', 2, 'MarkerSize',25, 'MarkerEdgeColor','blue')
grid on


%% Plot Coefficient
subplot(3,1,3)
plot(coeff,  '.-', 'LineWidth', 2, 'MarkerSize',15, 'MarkerEdgeColor','black')
grid on
